---
title: "Quality check, Block group intersections with neighborhoods"
...
nbd                                    %>%
  pull(AreaName)                       %>%
  str_subset("Tract", negate=TRUE)     %>%
  str_subset("Area", negate=TRUE)      -> interesting_nbd
for (i_NID in interesting_nbd) {
  # Draw neighborhood in green atop
